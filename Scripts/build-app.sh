...
product_name="Mac Monitor"
executable_name="MacMonitor"
...
<dict>
  ...
  <string>MacMonitor</string>
  <key>CFBundleIdentifier</key>
  <string>dev.sumetph.MacMonitor</string>
  <key>CFBundleIconFile</key>
  <string>AppIcon.icns</string>
  <key>CFBundleDisplayName</key>
  <string>Mac Monitor</string>
...
# Sign with Apple Development cert by default so Accessibility/Display permissions persist across builds.
